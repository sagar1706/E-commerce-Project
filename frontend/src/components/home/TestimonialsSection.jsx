    ...
    return (
        <>
            ...
            <section className="bg-gray-100 py-12">
                ...
                <div className="marquee-row w-full mx-auto max-w-5xl overflow-hidden relative mb-6">
                    ...
                    <div className="absolute right-0 top-0 h-full w-20 md:w-40 z-10 pointer-events-none bg-gradient-to-l from-gray-100 to-transparent"></div>
                </div>
